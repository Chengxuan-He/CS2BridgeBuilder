...
using BridgePrefabGenerator.Systems;
...
namespace BridgePrefabGenerator;

public sealed class Mod : IMod
{
    public const string Id = nameof(BridgePrefabGenerator);
    ...
    {
        ModHost.Initialize(Id, "Bridge Prefab Generator", Log);
