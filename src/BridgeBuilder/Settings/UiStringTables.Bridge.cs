...
internal static partial class UiStringTables
{
    ...
    private static UiStrings English(UiStrings text)
    {
        ...
        text.StateReportHint = "Full report: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
    ...
    private static UiStrings SimplifiedChinese(UiStrings text)
    {
        ...
        text.StateReportHint = "完整报告：ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "道路")
            .DeckKind("Train", "铁路")
    ...
    private static UiStrings TraditionalChinese(UiStrings text)
    {
        ...
        text.StateReportHint = "完整報告：ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "道路")
            .DeckKind("Train", "鐵路")
    ...
    private static UiStrings Japanese(UiStrings text)
    {
        ...
        text.StateReportHint = "詳細レポート: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "道路")
            .DeckKind("Train", "鉄道")
    ...
    private static UiStrings Korean(UiStrings text)
    {
        ...
        text.StateReportHint = "전체 보고서: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "도로")
            .DeckKind("Train", "철도")
    ...
    private static UiStrings German(UiStrings text)
    {
        ...
        text.StateReportHint = "Vollständiger Bericht: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
    ...
    private static UiStrings Spanish(UiStrings text)
    {
        ...
        text.StateReportHint = "Informe completo: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
    ...
    private static UiStrings French(UiStrings text)
    {
        ...
        text.StateReportHint = "Rapport complet : ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "Route")
            .DeckKind("Train", "Train")
    ...
    private static UiStrings Italian(UiStrings text)
    {
        ...
        text.StateReportHint = "Rapporto completo: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
    ...
    private static UiStrings Polish(UiStrings text)
    {
        ...
        text.StateReportHint = "Pełny raport: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "Droga")
    ...
    private static UiStrings Portuguese(UiStrings text)
    {
        ...
        text.StateReportHint = "Relatório completo: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
            .DeckKind("Road", "Via")
            .DeckKind("Train", "Trem")
    ...
    private static UiStrings Russian(UiStrings text)
    {
        ...
        text.StateReportHint = "Полный отчёт: ModsData\\BridgeBuilder\\last-export-report.txt";
        return text
            .DeckKind("RoadBuilder", "Road Builder")
